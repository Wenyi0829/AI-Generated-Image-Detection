...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='./genimage/val', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        # parser.add_argument('--classes', default='adm', help='image classes to train on')
        parser.add_argument('--classes', default='adm,biggan,glide,midjourney,sdv5,vqdm,wukong', help='image classes to train on')
